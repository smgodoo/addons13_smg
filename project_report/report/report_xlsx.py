...
class ReportXlsxAbstract(models.AbstractModel):
    _name = 'report.project_report.abstract'
    ...
    def create_xlsx_report(self, docids, data):
        ...
        workbook.set_properties({
            'title': 'Project report date {}'.format(datetime.datetime.now()),
            ...
            'comments': 'This report generated by Mr. Vuthy'})
        self.generate_forecast_xlsx_report(workbook, data, objs)
        workbook.close()
        file_data.seek(0)
